...
export function formatCompleteLayout(
  ...
  const repoUrl = `${github.context.serverUrl}/${process.env.GITHUB_REPOSITORY}`;
  ...
  // const committer = commit.data.author.login.replace(/-/g, "_")
  ...
  section.facts = [
    ...
    new Fact("Actor:", actor.replace(/-/g, "_")),
    new Fact(
      "Commit message:",

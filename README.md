...
- As much as possible, always set this Github action right after `actions/checkout@v4` and before any job steps. The following diagram shows when this job if going to trigger if done the right way.
